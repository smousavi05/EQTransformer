...
def trainer(input_hdf5=None,
    ...
    rubric:: Notes
        'generator' is memory efficient and more suitable for machines with fast disks. 
        'pre_load' is faster but requires more memory and it comes with only box labeling.
