...
def tester(input_hdf5=None,
    ...
    ----------
       ...
       input_testset: npy, (default = None)
           Path to a numpy file containing a list of trace names.
       ...
       estimate_uncertainty: bool, (default = True)
    ...
    rubric:: Notes
        ...
        'pre_load_generator' is faster but requiers more memory. 

    Generates
    -------
    ./output_name/X_test_results.csv 
    ...
    parser.add_argument("--input_testset", default=input_testset) 
...
def _output_writter_test(args, 
    ...
    pick_errors : dic
        Containes prediction errors for P and S picks..          
...
def _plotter(dataset, evi, args, save_figs, yh1, yh2, yh3, yh1_std, yh2_std, yh3_std, matches):
    ...
    ----------
    dataset : obj
        The hdf5 obj containting a numpy array of 3 component data and associated attributes.
    evi : str
        Trace name.  
    args : object
        A argparse object containing all of the input parameters. 
