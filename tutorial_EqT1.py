...
# -*- coding: utf-8 -*-
"""
    Created on Fri Mar 27 11:12:52 2020
...
# It will also generate one "station_name.hdf5" and one "station_name.csv" file for each of your stations 
# and put them into a directory named "mseed_dir+_hdfs". The above script generates one pickle file
# ("time_tracks.pkl") that you can use it to visualize the continuity and type of your data using the following module:
...
# You can use very low threshold values for the detection and picking since EQTransformer is 
# very robust to false positives. Enaibeling uncertaintiy estimation, outpur probabilities,
#  or plotting all the predictions will slow down the process. 
from EQTransformer.core.predictor import predictor
predictor(input_dir= 'downloads_mseeds_processed_hdfs',   
         input_model='sampleData&Model/eq11_054.h5',
...
# 'X_prediction_results.csv' contains detection/picking results in the figures folder you can find the plots 
# for the number of events that you specified in the above comment.

#You can choose between two different modes for your plots:
# the 'time_frequency'or 'time'

# These plots are useful to check out if your defined thresholds are a good choice or if you get some false positives.

# To check if you are missing too many events in the continuous data or catch most of them, 
# it is always good to check out the raw data. You can do it using these commands:
...
# This is much faster but is more memory intensive. So it is recommended when mseed fils are smalleer than 1 month.
# For instance you can not estimate the uncertainties anymore or use the advantages of having hdf5 file. 
...
trainer(input_hdf5='sampleData&Model/waveforms.hdf5',
        input_csv='sampleData&Model/metadata.csv',
